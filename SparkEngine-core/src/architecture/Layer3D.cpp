...
namespace sparky {
	namespace architecture {
		...
		Structure3D * Layer3D::getStructure(std::string structure)
		{
		...
		Component3D * Layer3D::getMisc(std::string misc)
		{
			std::unordered_map<std::string, Component3D*>::const_iterator got = miscellaneous.find(misc);
